...
int main(int argc, char *argv[])
{
    ...
    CfdemCloudChargePolarization particleCloud(mesh);
    ...
    while ( runTime.run() )
    {
        ...
        particleCloud.evolve(Ef,rhoe,voidfraction,Us,U,mixturePermittivity);
	...
	//solve electrical field and electric field gradient
	#include "phiEqn.H"

	// -- communicate values back to DEM --
	particleCloud.commValues();
	
	//send electric field and gradient to DEM
	particleCloud.evolveElectricField( Ef, gradEf );
