...
int main(int argc, char *argv[])
{
    ...
    // create cfdemCloud
    cfdemCoarseDPICloud particleCloud(mesh,voidfraction,Us,U);
	...
	// -- solve API particle concentration & communicate values to DEM --
	particleCloud.commValues();
	...
	*/
	...
	// -- write API concentration fields --
	if( runTime.outputTime() )
	{
	   particleCloud.apiWallDensity().write();
	   particleCloud.apiCarrierDensity().write();
	   
	   forAll(apiWallDensityVol.mesh().boundaryMesh(), patchI)
	   {
	       apiWallDensityVol.boundaryField()[patchI] = particleCloud.apiWallDensity().boundaryField()[patchI];
	   }
	   apiWallDensityVol.correctBoundaryConditions();
	   apiWallDensityVol.write();
