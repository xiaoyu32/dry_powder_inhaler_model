...
int main(int argc, char *argv[])
{
    ...
    CfdemCloudScalar particleCloud(mesh);
	...
	particleCloud.evolvePassiveScalar( 	
						passiveScalar, 
	...
	// -- solve for the passive scalar transport
	
	//compute passive scalar transfer with particles
	
	#include "passiveEqn.H"
	
	//communicate the flux to particles
	particleCloud.updatePassiveScalarSource( 	
						 passiveScalar
						);
