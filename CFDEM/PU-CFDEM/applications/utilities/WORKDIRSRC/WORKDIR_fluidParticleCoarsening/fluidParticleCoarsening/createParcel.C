...
{ 
	...
	{		
		...
		*/  
		...
		{				
			// Commented lines for the particle filtering case with particle used only one in a parcel
			...
			//	{
					...
					{						
                        ...
                        // Pout << " parcel " << parcelI << " nnIdx " << nnIdx[i] << " particleList " << particleList[nnIdx[i]] << endl;
                        parcelList[parcelI][i] = particleList[nnIdx[i]];
					}
		...
		{ 			
			...
			{				
                ...
                parcelDiameter[parcelII] = 2.*sm.radius(parcelListL[particleI]);
            }
		}
		...
		for(int index = 0; index < parcelsm.numberOfParticles(); index++)
		{
            ...
            //Pout << " index " << index << " cellI " << cellI << endl;
            if(cellI > -1)
			{						      
        ...
        Pout << " parcelIDInSubVolume " <<  parcelIDInSubVolume_.size() << " parcelI " << parcelList.size() << endl;
	/*				
