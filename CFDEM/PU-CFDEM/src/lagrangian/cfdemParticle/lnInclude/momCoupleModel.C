...
tmp<volTensorField> momCoupleModel::impMomSourceKslTensor() const
{
    FatalError<<"the solver calls for impMomSourceKslTensor()\n"
              <<", please set 'momCoupleModel' to type 'impMomSourceKslTensor'\n"
              << abort(FatalError);
