...
defineTypeNameAndDebug(MeiParcelLift, 0);
...
void MeiParcelLift::setForce() const
{
    // get viscosity field
    #ifdef comp
    ...
    for(int index = 0;index <  particleCloud_.numberOfParticles(); index++)
    {
        ...
        //{
		    ...
		    // Parcel approach: lift based on particle diameter
		    ...
		    // Parcel approach: lift on one particle multiply by number of particles in a parcel
		    if ( (parcelApproach_) && (ptype == apiType_) )
		    {
		    	lift *= npart_;
		    }
