...
autoPtr<chargeDensityModel> chargeDensityModel::New
(
...
)
{
    ...
    word chargeDensityModelType
    (
        dict.lookup("chargeDensityModel")
    );

    Info<< "Selecting chargeDensityModel "
         << chargeDensityModelType << endl;
