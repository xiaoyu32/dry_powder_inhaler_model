...
parDEMrun()
{
    ...
    if [ $machineFileName == "none" ]; then
	    srun --ntasks $nrProcs $debugMode $CFDEM_LIGGGHTS_SRC_DIR/$CFDEM_LIGGGHTS_LIB_NAME < $solverName 2>&1 | tee -a $logpath/$logfileName
#            mpirun --np $nrProcs $debugMode $CFDEM_LIGGGHTS_SRC_DIR/$CFDEM_LIGGGHTS_LIB_NAME < $solverName 2>&1 | tee -a $logpath/$logfileName

    else
        srun -machinefile $machineFileName --ntasks $nrProcs $debugMode $CFDEM_LIGGGHTS_SRC_DIR/$CFDEM_LIGGGHTS_LIB_NAME < $solverName 2>&1 | tee -a $logpath/$logfileName
    fi
...
parCFDrun()
{
    ...
    #- run applictaion
    if [ $machineFileName == "none" ]; then
        srun --ntasks $nrProcs $solverName 2>&1 | tee -a $logpath/$logfileName

#        mpirun -n $nrProcs $solverName 2>&1 | tee -a $logpath/$logfileName

    else
        srun -machinefile $machineFileName --ntasks $nrProcs $debugMode $solverName -parallel 2>&1 | tee -a $logpath/$logfileName
    fi
...
parCFDDEMrun()
{
    ...
    #- decompose case (JK: removed this)
    #decomposePar
    ...
    #- run applictaion
    if [ $machineFileName == "none" ]; then
        srun --ntasks $nrProcs $debugMode $solverName -parallel 2>&1 | tee -a $logpath/$logfileName
#        mpirun -n $nrProcs $debugMode $solverName -parallel 2>&1 | tee -a $logpath/$logfileName
        ...
        run -machinefile $machineFileName --ntasks $nrProcs $debugMode $solverName -parallel 2>&1 | tee -a $logpath/$logfileName
