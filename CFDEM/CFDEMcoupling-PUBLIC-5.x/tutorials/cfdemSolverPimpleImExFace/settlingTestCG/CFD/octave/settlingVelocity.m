...
plot(t_,U_, 'k--')
hold on
plot(t_sim,-U_sim(:,2),'rd-',t_sim,-U_sim2(:,2),'g<-')
legend("analytical - Stokes","simulation, CG=1","simulation, CG=2") 

%print('cfdemSolverPimpleImExFace_settlingTestCG.eps','-deps2')
print -color "cfdemSolverPimpleImExFace_settlingTestCG.png"
