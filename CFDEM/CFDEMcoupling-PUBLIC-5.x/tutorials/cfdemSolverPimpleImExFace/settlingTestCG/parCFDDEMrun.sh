...
logpath=$casePath
headerText="run_parallel_cfdemSolverPimpleImExFace_settlingTestCG_CFDDEM"
logfileName="log_$headerText"
solverName="cfdemSolverPimpleImExFace"
nrProcs="2"
...
if [ $runOctave == "true" ]
    then
        ...
        #- rmove old graph
        rm cfdemSolverPimpleImExFace_settlingTestCG.png

        #- run octave
        octave --no-gui settlingVelocity.m

        #- show plot 
        eog cfdemSolverPimpleImExFace_settlingTestCG.png

        #- copy log file to test harness
        cp ../../$logfileName $testHarnessPath
        cp cfdemSolverPimpleImExFace_settlingTestCG.png $testHarnessPath
fi
