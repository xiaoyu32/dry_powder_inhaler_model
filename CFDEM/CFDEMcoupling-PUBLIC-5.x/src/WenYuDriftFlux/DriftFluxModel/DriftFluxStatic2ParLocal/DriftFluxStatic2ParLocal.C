...
#include "DriftFluxStatic2ParLocal.H"
...
namespace Foam
{
  namespace dragModels
  {
    ...
    {
      defineTypeNameAndDebug(DriftFluxStatic2ParLocal,0);
      addToRunTimeSelectionTable(DriftFluxModel, DriftFluxStatic2ParLocal, dictionary);
    }
  }
}
...
Foam::dragModels::driftFluxModels::DriftFluxStatic2ParLocal::DriftFluxStatic2ParLocal
(
...
void Foam::dragModels::driftFluxModels::DriftFluxStatic2ParLocal::evolve()
{
