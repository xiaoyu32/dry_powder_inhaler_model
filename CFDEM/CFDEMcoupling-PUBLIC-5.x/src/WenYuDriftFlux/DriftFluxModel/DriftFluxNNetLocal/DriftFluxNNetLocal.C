...
namespace Foam
{
  namespace dragModels
  {
    ...
    {
      defineTypeNameAndDebug(DriftFluxNNetLocal,0);
      addToRunTimeSelectionTable(DriftFluxModel, DriftFluxNNetLocal, dictionary);
    }
  }
}
...
Foam::dragModels::driftFluxModels::DriftFluxNNetLocal::DriftFluxNNetLocal
(
...
void Foam::dragModels::driftFluxModels::DriftFluxNNetLocal::evolve()
{
