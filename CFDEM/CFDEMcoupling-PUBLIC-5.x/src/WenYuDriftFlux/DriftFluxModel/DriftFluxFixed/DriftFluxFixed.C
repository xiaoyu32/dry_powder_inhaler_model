...
namespace Foam
{
  namespace dragModels
  {
    ...
    {
      defineTypeNameAndDebug(DriftFluxFixed,0);
      addToRunTimeSelectionTable(DriftFluxModel, DriftFluxFixed, dictionary);
    }
  }
}
...
Foam::dragModels::driftFluxModels::DriftFluxFixed::DriftFluxFixed
(
...
void Foam::dragModels::driftFluxModels::DriftFluxFixed::evolve()
{
