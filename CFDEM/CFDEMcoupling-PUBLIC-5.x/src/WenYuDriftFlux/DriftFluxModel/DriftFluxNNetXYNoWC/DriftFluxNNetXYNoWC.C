...
namespace Foam
{
  namespace dragModels
  {
    ...
    {
      defineTypeNameAndDebug(DriftFluxNNetXYNoWC,0);
      addToRunTimeSelectionTable(DriftFluxModel, DriftFluxNNetXYNoWC, dictionary);
    }
  }
}
...
Foam::dragModels::driftFluxModels::DriftFluxNNetXYNoWC::DriftFluxNNetXYNoWC
(
...
void Foam::dragModels::driftFluxModels::DriftFluxNNetXYNoWC::evolve()
{
