...
namespace Foam
{
  namespace dragModels
  {
    ...
    {
      defineTypeNameAndDebug(DriftFlux2MarkerFS,0);
      addToRunTimeSelectionTable(DriftFluxModel, DriftFlux2MarkerFS, dictionary);
    }
  }
}
...
Foam::dragModels::driftFluxModels::DriftFlux2MarkerFS::DriftFlux2MarkerFS
(
...
void Foam::dragModels::driftFluxModels::DriftFlux2MarkerFS::evolve()
{
