...
namespace Foam
{
  namespace dragModels
  {
    ...
    {
      defineTypeNameAndDebug(DriftFluxNNet5,0);
      addToRunTimeSelectionTable(DriftFluxModel, DriftFluxNNet5, dictionary);
    }
  }
}
...
Foam::dragModels::driftFluxModels::DriftFluxNNet5::DriftFluxNNet5
(
...
void Foam::dragModels::driftFluxModels::DriftFluxNNet5::evolve()
{
  ...
  */
  ...
  (
   ...
   0.5*( Xsgs/(1.0-solidVolumeFraction)  
       + Ysgs)
  );
