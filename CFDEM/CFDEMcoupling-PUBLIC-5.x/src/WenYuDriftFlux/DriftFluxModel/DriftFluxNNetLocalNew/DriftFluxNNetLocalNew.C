...
#include "DriftFluxNNetLocalNew.H"
...
namespace Foam
{
  namespace dragModels
  {
    ...
    {
      defineTypeNameAndDebug(DriftFluxNNetLocalNew,0);
      addToRunTimeSelectionTable(DriftFluxModel, DriftFluxNNetLocalNew, dictionary);
    }
  }
}
...
Foam::dragModels::driftFluxModels::DriftFluxNNetLocalNew::DriftFluxNNetLocalNew
(
...
void Foam::dragModels::driftFluxModels::DriftFluxNNetLocalNew::evolve()
{
