...
#include "DriftFluxNNetLocalNewX8Y6NoWC.H"
...
namespace Foam
{
  namespace dragModels
  {
    ...
    {
      defineTypeNameAndDebug(DriftFluxNNetLocalNewX8Y6NoWC,0);
      addToRunTimeSelectionTable(DriftFluxModel, DriftFluxNNetLocalNewX8Y6NoWC, dictionary);
    }
  }
}
...
Foam::dragModels::driftFluxModels::DriftFluxNNetLocalNewX8Y6NoWC::DriftFluxNNetLocalNewX8Y6NoWC
(
...
void Foam::dragModels::driftFluxModels::DriftFluxNNetLocalNewX8Y6NoWC::evolve()
{
