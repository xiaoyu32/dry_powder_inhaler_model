...
#include "DriftFluxNNetWallNoCorrection.H"
...
namespace Foam
{
  namespace dragModels
  {
    ...
    {
      defineTypeNameAndDebug(DriftFluxNNetWallNoCorrection,0);
      addToRunTimeSelectionTable(DriftFluxModel, DriftFluxNNetWallNoCorrection, dictionary);
    }
  }
}
...
Foam::dragModels::driftFluxModels::DriftFluxNNetWallNoCorrection::DriftFluxNNetWallNoCorrection
(
...
void Foam::dragModels::driftFluxModels::DriftFluxNNetWallNoCorrection::evolve()
{
