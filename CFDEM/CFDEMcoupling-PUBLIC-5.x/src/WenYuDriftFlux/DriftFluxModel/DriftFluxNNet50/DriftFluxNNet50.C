...
namespace Foam
{
  namespace dragModels
  {
    ...
    {
      defineTypeNameAndDebug(DriftFluxNNet50,0);
      addToRunTimeSelectionTable(DriftFluxModel, DriftFluxNNet50, dictionary);
    }
  }
}
...
Foam::dragModels::driftFluxModels::DriftFluxNNet50::DriftFluxNNet50
(
...
void Foam::dragModels::driftFluxModels::DriftFluxNNet50::evolve()
{
...
//with diffusion
  ...
  (
    ...
    + fvm::div( phiUflux, driftFlux_ )
      ==
      50*(fvm::laplacian( driftFluxDiffusivity, driftFlux_ )
      //+ sumXY
