...
namespace Foam
{
  namespace dragModels
  {
    ...
    {
      defineTypeNameAndDebug(DriftFluxStatic2Par,0);
      addToRunTimeSelectionTable(DriftFluxModel, DriftFluxStatic2Par, dictionary);
    }
  }
}
...
Foam::dragModels::driftFluxModels::DriftFluxStatic2Par::DriftFluxStatic2Par
(
...
void Foam::dragModels::driftFluxModels::DriftFluxStatic2Par::evolve()
{
