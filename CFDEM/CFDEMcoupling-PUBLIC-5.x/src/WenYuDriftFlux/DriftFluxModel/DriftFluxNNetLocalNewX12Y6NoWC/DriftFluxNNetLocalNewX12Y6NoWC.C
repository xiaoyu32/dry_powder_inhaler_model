...
#include "DriftFluxNNetLocalNewX12Y6NoWC.H"
...
namespace Foam
{
  namespace dragModels
  {
    ...
    {
      defineTypeNameAndDebug(DriftFluxNNetLocalNewX12Y6NoWC,0);
      addToRunTimeSelectionTable(DriftFluxModel, DriftFluxNNetLocalNewX12Y6NoWC, dictionary);
    }
  }
}
...
Foam::dragModels::driftFluxModels::DriftFluxNNetLocalNewX12Y6NoWC::DriftFluxNNetLocalNewX12Y6NoWC
(
...
void Foam::dragModels::driftFluxModels::DriftFluxNNetLocalNewX12Y6NoWC::evolve()
{
...
//with diffusion
  ...
  (
    ...
    + fvm::div( phiUflux, driftFlux_ )
      ...
      //+ sumXY
      + 1.112*Xsgs/(1.0-solidVolumeFraction)  
      + Ysgs
  );
