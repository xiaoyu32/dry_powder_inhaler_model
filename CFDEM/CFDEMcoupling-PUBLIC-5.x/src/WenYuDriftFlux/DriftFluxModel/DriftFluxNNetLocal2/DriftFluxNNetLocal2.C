...
namespace Foam
{
  namespace dragModels
  {
    ...
    {
      defineTypeNameAndDebug(DriftFluxNNetLocal2,0);
      addToRunTimeSelectionTable(DriftFluxModel, DriftFluxNNetLocal2, dictionary);
    }
  }
}
...
Foam::dragModels::driftFluxModels::DriftFluxNNetLocal2::DriftFluxNNetLocal2
(
...
:
   ...
   (
	...
	pair.dispersed().U().mesh(),
	dimensionedVector("gradGradPgZ",dimensionSet(1,-3,-2,0,0),Foam::vector(0,0,0))
   ),  
   XnnModel_
   (
...
void Foam::dragModels::driftFluxModels::DriftFluxNNetLocal2::evolve()
{
  ...
  gradGradPgZ = fvc::grad(gradP.component(2));
