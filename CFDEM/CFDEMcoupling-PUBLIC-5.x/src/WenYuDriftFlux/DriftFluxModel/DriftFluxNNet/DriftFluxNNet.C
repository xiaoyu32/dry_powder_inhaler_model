...
namespace Foam
{
  namespace dragModels
  {
    ...
    {
      defineTypeNameAndDebug(DriftFluxNNet,0);
      addToRunTimeSelectionTable(DriftFluxModel, DriftFluxNNet, dictionary);
    }
  }
}
...
Foam::dragModels::driftFluxModels::DriftFluxNNet::DriftFluxNNet
(
...
void Foam::dragModels::driftFluxModels::DriftFluxNNet::evolve()
{
