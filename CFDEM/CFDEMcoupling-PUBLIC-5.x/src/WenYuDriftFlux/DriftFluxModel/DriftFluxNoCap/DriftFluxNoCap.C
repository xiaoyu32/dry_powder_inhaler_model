...
namespace Foam
{
  namespace dragModels
  {
    ...
    {
      defineTypeNameAndDebug(DriftFluxNoCap,0);
      addToRunTimeSelectionTable(DriftFluxModel, DriftFluxNoCap, dictionary);
    }
  }
}
...
Foam::dragModels::driftFluxModels::DriftFluxNoCap::DriftFluxNoCap
(
...
void Foam::dragModels::driftFluxModels::DriftFluxNoCap::evolve()
{
