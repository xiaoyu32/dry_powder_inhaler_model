...
namespace Foam
{
  namespace dragModels
  {
    ...
    {
      defineTypeNameAndDebug(DriftFluxNNet9,0);
      addToRunTimeSelectionTable(DriftFluxModel, DriftFluxNNet9, dictionary);
    }
  }
}
...
Foam::dragModels::driftFluxModels::DriftFluxNNet9::DriftFluxNNet9
(
...
void Foam::dragModels::driftFluxModels::DriftFluxNNet9::evolve()
{
