...
#include "DriftFluxNNetLocalNewX8Y6.H"
...
namespace Foam
{
  namespace dragModels
  {
    ...
    {
      defineTypeNameAndDebug(DriftFluxNNetLocalNewX8Y6,0);
      addToRunTimeSelectionTable(DriftFluxModel, DriftFluxNNetLocalNewX8Y6, dictionary);
    }
  }
}
...
Foam::dragModels::driftFluxModels::DriftFluxNNetLocalNewX8Y6::DriftFluxNNetLocalNewX8Y6
(
...
void Foam::dragModels::driftFluxModels::DriftFluxNNetLocalNewX8Y6::evolve()
{
