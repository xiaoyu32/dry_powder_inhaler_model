...
COHESION_MODEL(COHESION_VDW_PARCEL,vdw/parcel,7)
#else
#ifndef COHESION_MODEL_VDW_PARCEL_H_
#define COHESION_MODEL_VDW_PARCEL_H_
...
namespace ContactModels {
  ...
  template<>
  class CohesionModel<COHESION_VDW_PARCEL> : protected Pointers {
  public:
    ...
    void connectToProperties(PropertyRegistry & registry) {
      ...
      fix_nparcel = static_cast<FixPropertyGlobal*>(modify->find_fix_property("nparcel","property/particle","peratomtype",max_type,0,"vdw_parcel"));

      if( !fix_nparcel ) error->all(FLERR,"cohesion_model_vdw_parcel requires property/particle fix 'nparcel'!");
    ...
    void collision(CollisionData & cdata, ForceData & i_forces, ForceData & j_forces)
    {
      ...
      double Fn_coh = -cohEnergyDens[cdata.itype][cdata.jtype]/3.0
...
#endif // COHESION_MODEL_VDW_PARCEL_H_
#endif
