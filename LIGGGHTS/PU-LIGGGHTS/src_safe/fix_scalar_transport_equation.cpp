...
void FixScalarTransportEquation::post_create()
{
  ...
  if (fix_quantity==NULL) {
    ...
    fix_quantity=static_cast<FixPropertyParticle*>(modify->find_fix_property(quantity_name,"property/particle","scalar",0,0,style));
  }
  ...
  if (fix_flux==NULL){
    ...
    fixarg[8]="0.";
    modify->add_fix(9,const_cast<char**>(fixarg));
    fix_flux=static_cast<FixPropertyParticle*>(modify->find_fix_property(flux_name,"property/particle","scalar",0,0,style));
  }
  ...
  if (fix_source==NULL){
    ...
    fixarg[8]="0.";
    modify->add_fix(9,const_cast<char**>(fixarg));
    fix_source=static_cast<FixPropertyParticle*>(modify->find_fix_property(source_name,"property/particle","scalar",0,0,style));
  }
