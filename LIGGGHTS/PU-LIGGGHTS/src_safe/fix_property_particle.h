...
FixStyle(property/particle,FixPropertyParticle)

#else

#ifndef LMP_FIX_PROPERTY_PARTICLE_H
#define LMP_FIX_PROPERTY_PARTICLE_H
...
class FixPropertyParticle : public Fix {
 friend class Set;
 friend class FixPropertyAtomUpdateFix;
 friend class FixPropertyAtomRandom;
 friend class Properties;
 friend class PropertiesPu;
 public:
  FixPropertyParticle(class LAMMPS *, int, char **,bool parse = true);
  ~FixPropertyParticle();
  virtual int setmask();
