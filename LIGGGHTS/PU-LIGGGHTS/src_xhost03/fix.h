...
class Fix : protected Pointers {
 ...
 friend class CfdDatacouplingMPIpu;
 ...
 public:
  ...
  int just_created;              // 0/1 if fix was just created
  ...
  int recent_restart; 		 // 1 if true (LIGGHTS,JK)
  ...
  // -- liggghts post_create functions -- (JK)
