...
PairGran::~PairGran()
{
  ...
  //unregister energy terms as property/particle
...
void PairGran::init_style()
{
  ...
  if(energytrack_enable)
  {
      ...
      if (fppaCPEn == NULL) {
        ...
        fppaCPEn=static_cast<FixPropertyParticle*>(modify->find_fix_property("CPEn","property/particle","scalar",0,0,force->pair_style));
      }
      if (fppaCDEn == NULL) {
        fixarg[0]=(char *) "CDEn";
        fixarg[1]=(char *) "all";
        ...
        fixarg[8]=(char *) "0.0";
        modify->add_fix(9,fixarg);
        fppaCDEn=static_cast<FixPropertyParticle*>(modify->find_fix_property("CDEn","property/particle","scalar",0,0,force->pair_style));
      }
      if (fppaCPEt == NULL) {
          fixarg[0]=(char *) "CPEt";
          fixarg[1]=(char *) "all";
          ...
          fixarg[8]=(char *) "0.0";
          modify->add_fix(9,fixarg);
          fppaCPEt=static_cast<FixPropertyParticle*>(modify->find_fix_property("CPEt","property/particle","scalar",0,0,force->pair_style));
       }
       if (fppaCDEVt == NULL) {
         fixarg[0]=(char *) "CDEVt";
         fixarg[1]=(char *) "all";
         ...
         fixarg[8]=(char *) "0.0";
         modify->add_fix(9,fixarg);
         fppaCDEVt=static_cast<FixPropertyParticle*>(modify->find_fix_property("CDEVt","property/particle","scalar",0,0,force->pair_style));
       }
       if (fppaCDEFt == NULL) {
         fixarg[0]=(char *) "CDEFt";
         fixarg[1]=(char *) "all";
         ...
         fixarg[8]=(char *) "0.0";
         modify->add_fix(9,fixarg);
         fppaCDEFt=static_cast<FixPropertyParticle*>(modify->find_fix_property("CDEFt","property/particle","scalar",0,0,force->pair_style));
       }
       if (fppaCTFW == NULL) {
         fixarg[0]=(char *) "CTFW";
         fixarg[1]=(char *) "all";
         ...
         fixarg[8]=(char *) "0.0";
         modify->add_fix(9,fixarg);
         fppaCTFW=static_cast<FixPropertyParticle*>(modify->find_fix_property("CTFW","property/particle","scalar",0,0,force->pair_style));
      }
      if (fppaDEH == NULL) {
       fixarg[0]=(char *) "DEH";
       fixarg[1]=(char *) "all";
       ...
       fixarg[8]=(char *) "0.0";
       modify->add_fix(9,fixarg);
       fppaDEH=static_cast<FixPropertyParticle*>(modify->find_fix_property("DEH","property/particle","scalar",0,0,force->pair_style));
     }
    delete []fixarg;
  ...
  if(store_contact_forces_ && 0 == fix_contact_forces_)
  {
    ...
    fixarg[1]=(char *) "all";
    fixarg[2]=(char *) "contactproperty/particle";
  ...
  if(needs_neighlist)
  {
      ...
      neighbor->requests[irequest]->half = 1; // (XL) changed from 0
