...
FixStyle(efield/force/parcel,FixEfieldForceParcel)

#else

#ifndef LMP_FIX_EFIELD_FORCE_PARCEL_H
#define LMP_FIX_EFIELD_FORCE_PARCEL_H
...
namespace LAMMPS_NS {
  ...
  class FixEfieldForceParcel : public Fix {
  
  public:
    FixEfieldForceParcel(class LAMMPS *, int, char **);
    ~FixEfieldForceParcel();
