...
class Force : protected Pointers {
 ...
 public:
  ...
  void bounds(char *, int, int &, int &, int nmin=1); // -- LIGGHTS -- (JK)
  ...
  inline double chiStiffnessScaling() //chiStiffnessScaling contributed by Ali Ozel (Princeton University)
  { return chiStiff; }

  inline bool stiffnessScaling_active() 
  { return (chiStiffnessScaling() > 1.); }

  inline bool error_stiffnessScaling() 
  { return error_stiffScaling; }
