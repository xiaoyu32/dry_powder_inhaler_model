...
//using namespace LAMMPS_NS;
  ...
  void CustomValueTracker::updateMesh( const bool* prevIndex, const bool* currentIndex, const int nLocal, const int nGlobal)
  {  
      elementProperties_.updateMesh( prevIndex, currentIndex, nLocal, nGlobal );
  }
  
  void CustomValueTracker::preUpdate()
  {  
      elementProperties_.preUpdate();
  }
