...
public:
 ...
 protected:
  ...
  class FixPropertyParticle* fppaCPEn; //collision potential energy normal
  class FixPropertyParticle* fppaCDEn; //collision dissipation energy normal
  class FixPropertyParticle* fppaCPEt; //collision potential energy tang
  class FixPropertyParticle* fppaCDEVt; //collision dissipation energy viscous tang
  class FixPropertyParticle* fppaCDEFt; //collision dissipation energy friction tang
  class FixPropertyParticle* fppaCTFW; //collision tangential force work
  class FixPropertyParticle* fppaDEH; //dissipation energy of history term (viscous and friction, accumulated over time)
