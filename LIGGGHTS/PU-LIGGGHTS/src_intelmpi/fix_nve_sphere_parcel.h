...
FixStyle(nve/sphere/parcel,FixNVESphereParcel)

#else

#ifndef LMP_FIX_NVE_SPHERE_PARCEL_H
#define LMP_FIX_NVE_SPHERE_PARCEL_H
...
class FixNVESphereParcel : public FixNVESphere {
 public:
  FixNVESphereParcel(class LAMMPS *, int, char **);
  ~FixNVESphereParcel();
  void init();
