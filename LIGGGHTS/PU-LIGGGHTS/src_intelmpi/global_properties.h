...
namespace MODEL_PARAMS
{
  ...
  ScalarProperty* createCapDistanceViscousForce(PropertyRegistry & registry, const char * caller, bool sanity_checks);

  //triboelectricity parameters & electrostatics
  ScalarProperty* createPermittivity(PropertyRegistry & registry, const char * caller, bool); // - permittivity

  ScalarProperty* createScreeningDistance(PropertyRegistry & registry, const char * caller, bool); // - screening distance for (classical) P3M
