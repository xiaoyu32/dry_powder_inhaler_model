...
namespace LAMMPS_NS {
  ...
  protected:
    ...
    class FixPropertyParticle* fix_heatFlux;
    class FixPropertyParticle* fix_heatSource;
    class FixPropertyParticle* fix_temp;
    class FixScalarTransportEquation *fix_ste;
    class FixPropertyParticle* fix_directionalHeatFlux;
