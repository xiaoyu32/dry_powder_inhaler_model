...
namespace LAMMPS_NS
{
  class AbstractMesh : protected Pointers
  {
	...
	// -- used for updating the mesh elements after change in the processor domains --
	virtual void updateMesh()
	{
	    LocalTagUpdater::wallUpdated_ = true;
	}

	virtual void setActive( bool wallCommActive )
	{}	
	
	virtual bool pushData( char* id, void* tdata){ return false; };
	virtual bool pullData( char* id, void* fdata){ return false; };
	
	virtual int ncfd() const{ return 0; };
