...
vector<double> WallComm::parse_vector( std::string line, int i )
{
...
int WallComm::parse_int( std::string line )
{
...
double WallComm::parse_double( std::string line, int* i, bool& success )
{
    int j = i[0];
    int index = 0;
    std::string nbuffer;
