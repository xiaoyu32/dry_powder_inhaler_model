...
void Verlet::setup(int flag)
{
  ...
  //fprintf( screen, "Verlet::setup(int flag) (1) \n" ); //FIXME
...
void Verlet::run(int n)
{
  ...
  for (int i = 0; i < n; i++) {
    ...
    //if( proc_id == 0 ) fprintf( screen, "Finished running (middle)   %d/%d \n", i+1,n ); //FIXME
    ...
    //if( proc_id == 0 ) fprintf( screen, "Finished running (final_integrate) (1)  %d/%d \n", i+1,n ); //FIXME
