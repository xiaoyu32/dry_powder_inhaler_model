                              ...
                              double *argstack, int &nargstack)
{
  ...
  //printf( "atom->map_tag_max = %d \n", atom->map_tag_max ); //fixme
  ...
  if (index >= 0 && index < atom->nlocal) {
    ...
    if (flag == 0) {
      ...
      else if ((strcmp(word,"Wx") == 0) && atom->omega_flag) mine = atom->omega[index][0]; // -- liggghts --
      else if ((strcmp(word,"Wy") == 0) && atom->omega_flag) mine = atom->omega[index][1]; // -- liggghts --
      else if ((strcmp(word,"Wz") == 0) && atom->omega_flag) mine = atom->omega[index][2]; // -- liggghts --
      else if ((strcmp(word,"tqx") == 0) && atom->torque_flag) mine = atom->torque[index][0];  // -- liggghts --
      else if ((strcmp(word,"tqy") == 0) && atom->torque_flag) mine = atom->torque[index][1];  // -- liggghts --
      else if ((strcmp(word,"tqz") == 0) && atom->torque_flag) mine = atom->torque[index][2];  // -- liggghts --    
...
int Variable::is_atom_vector(char *word)
{
  ...
  if ((strcmp(word,"Wx") == 0) && atom->omega_flag) return 1; // -- liggghts --
  if ((strcmp(word,"Wy") == 0) && atom->omega_flag) return 1;
  if ((strcmp(word,"Wz") == 0) && atom->omega_flag) return 1;
  if ((strcmp(word,"tqx") == 0) && atom->torque_flag) return 1;
  if ((strcmp(word,"tqy") == 0) && atom->torque_flag) return 1;
  if ((strcmp(word,"tqz") == 0) && atom->torque_flag) return 1;  // -- liggghts --   
  return 0;
}
                           ...
                           Tree **treestack, int &ntreestack)
{
  ...
  else if ((strcmp(word,"Wx") == 0) && atom->omega_flag) newtree->array = &atom->omega[0][0]; // -- liggghts --
  else if ((strcmp(word,"Wy") == 0) && atom->omega_flag) newtree->array = &atom->omega[0][1];
  else if ((strcmp(word,"Wz") == 0) && atom->omega_flag) newtree->array = &atom->omega[0][2];
  ...
  else if ((strcmp(word,"tqz") == 0) && atom->torque_flag) newtree->array = &atom->torque[0][2]; // -- liggghts --
