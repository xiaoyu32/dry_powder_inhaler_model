...
#define LMP_MULTI_NODE_MESH_PARALLEL_BUFFER_I_H
  ...
  void MultiNodeMeshParallel<NUM_NODES>::restart(double *list)
  {
      ...
      {
          //std::cout<<"FAILED RESTART: "<< sE<<" "<< sM <<" "<< sizeRestartElement()<<" "<< sizeRestartMesh()<<std::endl;
      ...
      //std::cout<<"(1): nglobal = "<<nglobal<<"  nLocal = "<<nLocal_<<std::endl; //fixme
      ...
      //std::cout<<"(2): nglobal = "<<nglobal<<"  nLocal = "<<nLocal_<<std::endl;  //fixme
