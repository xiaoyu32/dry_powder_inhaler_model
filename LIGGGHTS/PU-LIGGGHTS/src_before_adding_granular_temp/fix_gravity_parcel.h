...
FixStyle(gravity/parcel,FixGravityParcel)

#else

#ifndef LMP_FIX_GRAVITY_PARCEL_H
#define LMP_FIX_GRAVITY_PARCEL_H

#include "fix.h"

namespace LAMMPS_NS {

class FixGravityParcel : public Fix {
  friend class FixPour;

 public:
  FixGravityParcel(class LAMMPS *, int, char **);
  virtual ~FixGravityParcel();
  int setmask();
  void init();
  void setup(int);
