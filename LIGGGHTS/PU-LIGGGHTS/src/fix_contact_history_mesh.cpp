...
void FixContactHistoryMesh::init()
{
  ...
  fix_nneighs_ = static_cast<FixPropertyParticle*>(modify->find_fix_property(fix_nneighs_name,"property/particle","scalar",0,0,this->style));
