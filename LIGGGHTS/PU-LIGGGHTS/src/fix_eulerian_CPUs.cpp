...
vector<double> FixEulerianCPUs::parse_vector( string line, int i )
{
...
int FixEulerianCPUs::parse_int( string line )
{
...
double FixEulerianCPUs::parse_double( string line, int* i, bool& success )
{
    int j = i[0];
    int index = 0;
    string nbuffer;
